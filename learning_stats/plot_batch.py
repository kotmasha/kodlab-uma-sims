...
AGENT_TYPES={
    '_Q1':['qualitative','xkcd:red'],
    '_Q2':['qualitative','xkcd:red'],
    '_Eu':['empirical uniform','xkcd:sky blue'],
    '_Ev1':['empirical value-based','xkcd:blue'],
    '_Ev2':['empirical value-based','xkcd:blue'],
    '_Du':['discounted uniform','xkcd:green'],
    '_Dv1':['discounted value-based','xkcd:forest green'],
    '_Dv2':['discounted value-based','xkcd:forest green'],
    }

ORDERED_TYPES=['_Q1','_Ev1','_Dv1','_Q2','_Ev2','_Dv2']
